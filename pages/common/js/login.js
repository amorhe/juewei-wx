...
const loginPage = {
  ...
  decryptPhone: '/juewei-api/alimini/decryptPhone', // 解密手机
}
...
export const loginByAuth = (phone, code, userInfo, rawData, signature, encryptedData, iv, cloudID) => ajax(loginPage.loginByAuth, { phone, code, userInfo, rawData, signature, encryptedData, iv, cloudID});
